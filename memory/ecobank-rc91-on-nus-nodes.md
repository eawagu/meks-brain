...
**Situation lifecycle:** remains `developing` — transaction-routing layer implicitly recovered but admin-portal layers (TDSD-6711 + user-creation 3-week) remain open. `resolving` requires either (a) admin-portal layers validated recovery via Slack/email closure post + Mayowa attribution-mismatch pattern addressed or (b) extended stable-window with admin-portal stack re-verified.

**Next-check gate:** briefing-2026-04-24 D1 CTO-escalation options (1/2/3) — user disposition pending. D1 case strengthens on the admin-portal stack (3-week user-creation + TDSD-6711) even with transaction-routing layer implicitly recovered.

## Sources
Gmail Afeez 2026-04-17 12:01 WAT; Slack Adewuyi Mayowa 2026-04-17 12:15 WAT; Gmail Afeez → Ecobank 2026-04-18 16:09 WAT (thread 19da12452e0edb2e); Gmail Afeez 2026-04-18 16:36 WAT; Jira TDSD-6619 2026-04-18 20:17 WAT; Gmail Daniel Armstrong 2026-04-19 15:01 WAT (thread 19da60c7ea537e24); Gmail Adewuyi Mayowa 2026-04-19 16:29 WAT; Gmail Afeez 2026-04-19 17:24 WAT; Gmail Daniel 2026-04-23 06:35 WAT (cycle-A thread 19db8d64f00a406d); Gmail Olamide 2026-04-23 08:52 WAT; Slack #teamapt-tech-operations 2026-04-23 09:38 WAT (cycle-A P1, message_ts 1776934715); Gmail Adewuyi Mayowa 2026-04-23 10:19 WAT (resolution claim); Gmail Olamide Ajibulu 2026-04-23 14:38 WAT (cycle-B thread 19dbac740631c4f9); Gmail Qazim 2026-04-23 16:37 WAT (cycle-B fine-now); Gmail Qazim 2026-04-23 17:36 WAT (cycle-B resurface); Gmail Qazim 2026-04-23 21:33 WAT (portal inaccessibility thread 19dbc43766215aeb); Jira TDSD-6711 2026-04-23 22:32 WAT; Gmail Qazim 2026-04-23 21:36 + 23:03 WAT hourly reports; Gmail Qazim → Daniel 2026-04-23 23:06 WAT duty handover; Gmail 2026-04-24 13:21 WAT thread 19dbf704dc7edb8a (3-week user-creation escalation); **Gmail 2026-04-24 16:07 WAT thread 19dc0083cbfa1990 (Afeez → Olamide intraday duty handover — Ecobank absent from turned-off list, transaction-routing layer implicit recovery)**
...
- [2026-04-24 14:09 WAT — observation] — **Third DCIR-portal failure mode layer: user-creation 3-week persistent escalation** (thread 19dbf704dc7edb8a, Mayowa-signed from Ecobank side, cross-team joint review, web-server patch/upgrade root cause candidate). Strengthens D1 CTO-escalation case.
- [2026-04-24 16:09 WAT — route back to operational per intraday duty handover] — **Transaction-routing layer implicit recovery.** Afeez → Olamide intraday Duty Handover Note 16:07 WAT Apr 24 (Gmail thread 19dc0083cbfa1990): *"14 of 17 PTSAs operational. First bank, providus and sterling are turned off due to RC91 - MP decision."* **Ecobank is absent from the off-list**, reversing the 23:06 WAT Apr 23 overnight handover state which had listed Ecobank as failing RC 91 going into overnight delegation. Route re-enabled between 23:06 WAT Apr 23 and 16:07 WAT Apr 24 — **no visible TeamApt-side validation post observed in the sweep window** (cycle-B/C Slack P1 closure still absent even as route now operational). **Admin-portal layers remain open:** TDSD-6711 (no Jira update this tick) + user-creation 3-week escalation (no email follow-up this tick). **Compound framing shifts** from three-stacked-failures (cycles + portal access + user creation) to admin-platform destabilization (portal access + user creation persisting despite transaction-routing layer recovered). briefing-2026-04-24 D1 CTO-escalation case still applicable: user-creation 3-week persistence under cross-team review + TDSD-6711 portal access still Work In Progress = admin-platform signal strengthens independent of transaction-routing status. No Immediate dispatch — route recovery is positive signal, not alarm; admin-portal layers not newly-critical this tick. Briefing-2026-04-25 Awareness candidate: route-recovery + admin-layers-still-open = two-layer Ecobank state. Factors: source=email, active_situation_entity_match=ecobank, duty_handover_implicit_route_reenabled, rc91_layer_implicit_recovery, admin_portal_layers_still_open_tdsd6711_plus_3week_user_creation, no_teamapt_side_validation_post, compound_framing_shifts_from_cycles_to_admin_platform, d1_cto_escalation_case_still_applicable_on_admin_stack, no_immediate_dispatch, briefing_2026_04_25_awareness_candidate.
