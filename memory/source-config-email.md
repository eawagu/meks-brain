...
**BRIEFING-PROMOTION THRESHOLD CROSSED — Tool Upgrade Error, 4th consecutive tick (2026-04-17 17:09 WAT):** Gmail MCP `gmail_search_messages` returned `"This Google Workspace integration was just upgraded and the tool you tried to call no longer exists. Your tool definitions are stale..."` for the fourth consecutive tick. Failure windows: 14:09 WAT (1st), 15:09 WAT (2nd), 16:09 WAT (3rd), 17:09 WAT (4th). The 13:09 WAT tick and earlier succeeded. Failure isolated per heartbeat error-handling rule: logged and moved on, no retry.
