...
ATPP standup on Apr 27, 2026 (15:51 WAT) covered card processing milestones, system status, and operational adjustments. Issuer public key certificate generated and Visa test keys loaded on HSM; card data awaiting EMV prep output for white plastic production. CMS security documentation still unavailable (revised partner timeline end-of-May). Dispute management sprint officially kicked off, ACT enhancements deployed, and account migration set to run in two separate batches.
...
- **Document standardization**: Incorporating white plastic production and host-to-host test updates
- **Regulatory compliance**: List being completed; sharing with compliance team by close of business
- **Acquiring products / Visa 3DS**: Pilot transaction simulation needed; internal compliance review completed
- **Mastercard e-commerce**: Awaiting documentation for review; onboarding draft review underway
- **Dispute management**: Sprint officially kickstarted; continuation underway this week
