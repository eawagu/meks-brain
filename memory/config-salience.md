...
summary: "Exec assistant salience scoring — triage tiers with trigger conditions, dimension weights, absence-of-signal rules, tuning mechanism with missed signal capture (triage-time + async MISS: notes), threshold-based recalculation trigger (20 tuples), and structured recalculation protocol. 9 tuples accumulated post-recalc (2 new MISSes appended 2026-04-25 ingest: BambooHR Layer 1 silent 5 days, Slack epoch bug week-aligned drift)."
updated: "2026-04-25T11:35:06Z"
cssclasses:
  - "config"
---
