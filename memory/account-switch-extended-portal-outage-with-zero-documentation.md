...
summary: "Portal unreachable since Apr 9 ~06:00 WAT (now ~78h+). Three Jira tickets (TDSD-6488, TDSD-6508, TDSD-6512). Hourly Report 20260412 (11:59 WAT) reconfirms transactions routed off, awaiting Paystack reroute. Window 1 reports completed on portal."
updated: "2026-04-12T11:12:36Z"
cssclasses:
  - "situation"
accountability: Technology Reliability and Security
---

[[Account Switch]] portal unreachable since Apr 9 ~06:00 WAT. Now ~78h+ outage. Hourly Report 20260412 ([[Qazim Adedigba]], 11:59 WAT Apr 12) reconfirms: "Account Switch transactions are routed off due to ongoing maintenance; we are awaiting Paystack to reroute traffic and reconfirm the status." Window 1 reports (TeamApt Revenue Report, Fees, Settlements Advice, Settlement Reports) have been completed on the portal — indicating partial portal functionality restored for reporting, while transaction routing remains off.

Three Jira tickets: [[TDSD-6488]], [[TDSD-6508]], [[TDSD-6512]]. Jira auth failure prevents current ticket status verification (14th consecutive tick). SLA breach occurred 13:40 WAT Apr 10. This remains a process failure on record — 78h+ outage with minimal Jira documentation.

## Sources
email Duty Handover #20260409; email Daily Report #20260411; email Duty Handover #20260412; email Hourly Reports 20260412 (Qazim Adedigba, 09:24 WAT and 11:59 WAT Apr 12); jira TDSD-6483, TDSD-6488, TDSD-6508, TDSD-6512; slack #account-switch-alerts; slack #teamapt-tech-operations; slack #teamapt-x-paystack-transfer-support
...
- 2026-04-12 12:09 WAT — Hourly Report 11:59 WAT reconfirms same status. No change. ~78h+ total outage. Jira auth failure continues (14th tick).