...
summary: "Sterling OFF Day 6+ on settlement; Polaris RC91 P1 silent 2h31m since 11:39 WAT filing, now crosses Immediate #2 threshold — consolidated dispatch with NIBSS."
updated: "2026-04-17T14:15:04Z"
cssclasses:
  - "situation"
...
Status remains `developing` for the Polaris P1. The Polaris event co-occurs with [[NIBSS PTSA — Intermittent RC91 Apr 17]] (active 5h40m+), a previously-missed [[Wema Bank — RC91 P1 Apr 17]] (8:49 WAT start, 6h20m active, first caught this tick), reopened [[Ecobank — RC91 on NUS Nodes]] with Adewuyi Mayowa contesting attribution at 12:15 WAT, and cycle 26 on [[Stanbic Bank ATS — Persistent RC91 Pattern]]. Cross-route concurrence continues across the noon and early-afternoon windows and now extends all the way back to 08:49 WAT (Wema).
...
- Sterling settlement remains OFF Day 6+ — no resolution signal in the early-afternoon tick window.
