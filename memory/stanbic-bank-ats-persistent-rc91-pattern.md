...
summary: "21+ P1 RC91 cycles in 12 days (Apr 3–13). Cycle 21+ evening Apr 13: resurfaced 21:30 WAT, resolved 21:59 WAT (~30min). Oladapo Onayemi investigating Moniepoint processing latency per NIBSS attribution — commitment due Apr 15. Escalation posture decision 8+ days overdue."
updated: "2026-04-13T21:56:05Z"
cssclasses:
  - "situation"
accountability: Technology Reliability and Security
---

Twenty-one+ confirmed P1 cycles Apr 3–13 (12 days), all bank-resolved, same root cause unfixed. [[TDSD-6425]] administratively closed Apr 10 — closure does NOT resolve the strategic escalation posture decision. "Decide [[Stanbic Bank]] ATS escalation posture" state item 8+ days overdue (due Apr 6). 

**Investigation track:** [[Oladapo Onayemi]] tasked with investigating whether Moniepoint processing latency to NIBSS node is anomalous (per NIBSS attribution of RC91 to Moniepoint timeout). Commitment due Wed Apr 15. No completion signal as of Apr 13 22:29 WAT.

Cycle 21+ on Apr 13 evening: [[Daniel Armstrong]] reported issue resurfaced at 21:30 WAT (email to Stanbic — Samson Ibekwe, Chukwuemeka Erobi, Onyedikachukwu Udeaja, Qazim Adedigba, Godwin Ajiboye, Peace Ikhuenbor, TechnologyCardSupport, Olohi Peter, Mayor Onyebueke, Damilola Badiru, Oluwatobi Meshioye, Toluwase Shorun, Oladipo Oluawe, Nzube Okezie, Service Monitoring, IT Service Management, ITSM Team). Stanbic SRE ([[Samson Ibekwe]]) acknowledged "receiving attention" at 20:41 UTC, then requested reconfirmation at 20:58 UTC. [[Daniel Armstrong]] confirmed "transactions are processing fine" at 21:59 WAT. Duration: ~30 min. Standard quick-cycle pattern.

Concurrent UBA RC91 on same evening: [[Daniel Armstrong]] reported UBA failing at 19:21 WAT (TDSD-6492), multiple reconfirmation requests from UBA (Rasheed Olanrewaju), resolved by 21:51 WAT. Multi-bank evening RC91 consistent with prior pattern.
