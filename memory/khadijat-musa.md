...
TeamApt team member — owns the [[Direct to Bank program]] daily standup meeting (khadijat.musa@teamapt.com is the Drive owner on each meeting note).

## 2026-04-21 — D2B standup (08:10 WAT)

- Chaired the standup; concluded the refund discussion by reminding [[Babajide Ojoboorun]] and [[Ugochukwu Ebirika]] that they need to **review all outstanding issues to prioritize which ones to address**.
- Asked [[Abdulgafar Obeitor]] to confirm the Fund Settlement Agent account number source. [[Ifeoluwa Oguntona]] suggested while Finance can provide a list, [[Kevin]] should select; Abdulgafar confirmed always involve Kevin when reaching out to Finance for accounts.
- Source: [[Direct to Bank Daily standup - 2026-04-21 08:10 WAT]].

## 2026-04-22 — D2B standup (08:21 WAT)

- Khadijat is the Drive owner of the meeting note; [[Abraham Isinguzoro]] reported on her behalf for the Opay/Union Bank pipeline at the prior standup.
